...
--
-- Table structure for table `tbluserdtl`
--

DROP TABLE IF EXISTS `tbluserdtl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbluserdtl` (
  `SiteNo` int NOT NULL,
  `UserNo` int NOT NULL,
...
--
-- Dumping data for table `tbluserdtl`
--

LOCK TABLES `tbluserdtl` WRITE;
...
-- Dump completed on 2021-01-26 16:16:40
